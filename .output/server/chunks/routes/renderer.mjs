...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Explore sheriff culture, jokes, and global sayings"}],"link":[{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Rye&display=swap"}],"style":[],"script":[],"noscript":[],"title":"Sheriff Culture Hub"};
